"""
Django settings for Inspiry_Project project.
...
SECRET_KEY = 'django-insecure-#x!8+%*j(ifra(!#8v2nujd%*rm=huouyy=bw+v(ftry8ud*@2'
...
ROOT_URLCONF = 'Inspiry_Project.urls'
...
WSGI_APPLICATION = 'Inspiry_Project.wsgi.application'
